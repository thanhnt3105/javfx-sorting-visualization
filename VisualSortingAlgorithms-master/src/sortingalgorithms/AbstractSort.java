...
public abstract class AbstractSort {
	  ...
	  final Color SORTED_COLOR = Color.BLUE;

	  static int DX;
	  static {
		  DX = AnimationController.WINDOW_WIDTH / AnimationController.NO_OF_CNODES; //=20
	  }
	  ...
	  ParallelTransition colorCNode(CNode[] arr, Color color, int...a) {
		  ...
		  for (int i = 0; i < a.length; i++) {
		      ...
		      ft.setShape(arr[a[i]]);
		      ft.setToValue(color);
		      ft.setDuration(Duration.millis(AnimationController.SPEED));
